...
export function ReviewsDashboard({ reviews, invitedUsers }: ReviewsDashboardProps) {
  ...
  const handleSendInvitation = () => {
    ...
    // This would typically open an invitation dialog
  };

  const handleEmailReport = () => {
    console.log('Sending email report');
    // This would typically trigger an email report
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-900 mb-4 sm:mb-0">Reviews</h1>
