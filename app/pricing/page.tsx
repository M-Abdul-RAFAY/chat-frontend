    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-blue-600 hover:bg-blue-700">Pricing Plans</Badge>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Unified communication platform with SMS, email, WhatsApp, and social media management
          </p>
        </div>
          ...
          <TabsContent value="plans">
                  ...
                  <CardContent className="flex-grow space-y-4">
                    <div className="space-y-2 pb-4 border-b border-slate-200">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-semibold">{plan.conversations}/mo</span>
                      </div>
                      <div className="flex justify-between text-sm">
            ...
            <Card className="mb-16 border-slate-200">
              <CardHeader>
                ...
                <CardDescription>
                  Customize your plan with these additional features (Available for Starter, Professional & Business plans)
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Conversations/month</td>
                        <td className="py-3 px-4 text-center text-sm">500</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">2,000</td>
                        <td className="py-3 px-4 text-center text-sm">10,000</td>
                        <td className="py-3 px-4 text-center text-sm">Unlimited</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">SMS Messages/month</td>
                        <td className="py-3 px-4 text-center text-sm">1,000</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">5,000</td>
                        <td className="py-3 px-4 text-center text-sm">20,000</td>
                        <td className="py-3 px-4 text-center text-sm">Custom</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">User Seats</td>
                        <td className="py-3 px-4 text-center text-sm">1</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">5</td>
                        <td className="py-3 px-4 text-center text-sm">15</td>
                        <td className="py-3 px-4 text-center text-sm">Unlimited</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Locations</td>
                        <td className="py-3 px-4 text-center text-sm">1</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">1</td>
                        <td className="py-3 px-4 text-center text-sm">5</td>
                        <td className="py-3 px-4 text-center text-sm">Unlimited</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Unified Inbox</td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">AI Auto Response</td>
                        <td className="py-3 px-4 text-center text-sm">Basic</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">Advanced</td>
                        <td className="py-3 px-4 text-center text-sm">Custom</td>
                        <td className="py-3 px-4 text-center text-sm">Enterprise AI</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">SMS Integration</td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Email Integration</td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">WhatsApp</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Social Media Channels</td>
                        <td className="py-3 px-4 text-center text-sm">2</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">Unlimited</td>
                        <td className="py-3 px-4 text-center text-sm">Unlimited</td>
                        <td className="py-3 px-4 text-center text-sm">Unlimited</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Social Media Dashboard</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">SMS Opt-in Widget</td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center text-sm">Custom</td>
                        <td className="py-3 px-4 text-center text-sm">White-label</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Quick Response Widget</td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center text-sm">Custom</td>
                        <td className="py-3 px-4 text-center text-sm">White-label</td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Bulk Messages</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Marketing Campaigns</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Performance Dashboard</td>
                        <td className="py-3 px-4 text-center text-sm">Basic</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">Complete</td>
                        <td className="py-3 px-4 text-center text-sm">Advanced</td>
                        <td className="py-3 px-4 text-center text-sm">Custom Reports</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">AI Performance Tracking</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Team Performance</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Review Management</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Brand Guidelines</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center text-sm">Multiple</td>
                        <td className="py-3 px-4 text-center text-sm">White-label</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">AI Training Data</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center text-sm">Custom</td>
                        <td className="py-3 px-4 text-center text-sm">Enterprise</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Calendar Integration</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Personal Assistant</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Call Tracking</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                        <td className="py-3 px-4 text-center"><Check className="h-5 w-5 text-green-600 mx-auto" /></td>
                      ...
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">API Access</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">Basic</td>
                        <td className="py-3 px-4 text-center text-sm">Full</td>
                        <td className="py-3 px-4 text-center text-sm">Custom</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Support</td>
                        <td className="py-3 px-4 text-center text-sm">Email</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">24/7 Chat</td>
                        <td className="py-3 px-4 text-center text-sm">Priority</td>
                        <td className="py-3 px-4 text-center text-sm">Dedicated Manager</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">SLA</td>
                        <td className="py-3 px-4 text-center"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center bg-blue-50"><X className="h-5 w-5 text-slate-300 mx-auto" /></td>
                        <td className="py-3 px-4 text-center text-sm">99.9%</td>
                        <td className="py-3 px-4 text-center text-sm">99.99%</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 text-sm font-medium text-slate-700">Storage</td>
                        <td className="py-3 px-4 text-center text-sm">2GB</td>
                        <td className="py-3 px-4 text-center text-sm bg-blue-50">10GB</td>
            ...
            <div className="mt-8 p-6 bg-slate-900 rounded-xl text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-slate-800 p-4 rounded-lg">
                  ...
                  <div className="text-xs text-slate-400">SMS/month included</div>
                  <div className="text-sm mt-2 text-slate-300">Overage: $0.02/msg</div>
                </div>
                <div className="bg-slate-800 p-4 rounded-lg border-2 border-blue-600">
                  <div className="text-sm text-slate-400 mb-1">Professional</div>
                  <div className="text-2xl font-bold mb-2">5,000</div>
                  <div className="text-xs text-slate-400">SMS/month included</div>
                  <div className="text-sm mt-2 text-slate-300">Overage: $0.015/msg</div>
                </div>
                <div className="bg-slate-800 p-4 rounded-lg">
                  <div className="text-sm text-slate-400 mb-1">Business</div>
                  <div className="text-2xl font-bold mb-2">20,000</div>
                  <div className="text-xs text-slate-400">SMS/month included</div>
                  <div className="text-sm mt-2 text-slate-300">Overage: $0.01/msg</div>
                </div>
                <div className="bg-slate-800 p-4 rounded-lg">
                  ...
                  <div className="text-sm mt-2 text-slate-300">From $0.005/msg</div>
                </div>
              </div>
            </div>
          </TabsContent>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-slate-600 mb-6">Our team is here to help you choose the right plan</p>
